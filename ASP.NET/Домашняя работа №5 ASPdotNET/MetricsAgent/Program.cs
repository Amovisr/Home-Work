...
namespace MetricsAgent
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped<IErrorMetricsRepository, ErrorMetricsRepository>();
            ...
            builder.Services.AddSingleton<ErrorMetricJob>();
            ...
            builder.Services.AddSingleton(new JobSchedule(typeof(ErrorMetricJob), "0/5 * * ? * * *"));
