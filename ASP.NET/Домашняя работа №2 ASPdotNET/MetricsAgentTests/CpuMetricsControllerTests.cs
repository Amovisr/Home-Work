...
namespace MetricsAgentTests
{
    ...
    public class CpuMetricsControllerTests
    {
        ...
        private CpuMetricsController _cpuPercentilesMetricsController;

        public CpuMetricsControllerTests()
        {
            _cpuMetricsController = new CpuMetricsController();
            _cpuPercentilesMetricsController = new CpuMetricsController();
        }
        ...
        [Fact]
        public void GetCpuPercentilesMetrics_ReturnOk()
        {
            TimeSpan fromTime = TimeSpan.FromSeconds(0);
            TimeSpan toTime = TimeSpan.FromSeconds(100);
            var result = _cpuPercentilesMetricsController.GetCpuPercentilesMetrics(fromTime, toTime);
            Assert.IsAssignableFrom<IActionResult>(result);
        }
